...
export default function TaskBoard({ tasks, tab, onTabChange, selectedRunnerName, runners, embedded = false, onEdit, onDelete }: Props) {
  return <section className={`flex min-w-0 flex-col p-4 lg:min-h-0 lg:flex-1 ${embedded ? "" : "rounded-[24px] border border-border bg-surface shadow-[var(--shadow-card)] md:p-5"}`}>
